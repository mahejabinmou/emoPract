  ...
  return (
    <div className="relative">
      ...
      <div className="slider-container ">
        <Slider {...settings}>
          <div className="relative ">
            <div className='bg-[url("https://i.ibb.co/K00S7wX/Asset-2-4x.webp")] bg-no-repeat bg-center bg-cover w-[100%] h-[100dvh]'>
              {/* Hero Image Content */}
          ...
          {/* slider two */}
          <div className="relative">
            <div className='bg-[url("https://i.ibb.co/p41vrrw/A7405738.jpg")] bg-no-repeat bg-center bg-cover w-[100%] h-[100dvh]'>
              {/* Hero Image Content */}
              <div className="heroImgParent">
                <div>
                  <h2 className="commonTitle pb-[10px] md:pb-[15px] lg:pb-[15px]xl:pb-[25px] 2xl:pb-[25px]">
          ...
          {/* slider three */}
          <div className="relative">
            <div className='bg-[url("https://i.ibb.co/rp0drJW/WDW-0942.jpg")] bg-no-repeat bg-center bg-cover w-[100%] h-[100dvh]'>
              {/* Hero Image Content */}
              <div className="heroImgParent">
                <div>
                  <h2 className="commonTitle pb-[10px] md:pb-[15px] lg:pb-[15px]xl:pb-[25px] 2xl:pb-[25px]">
